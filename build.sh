...
GOOS=linux GOARCH=amd64 go build -ldflags "-X main.DBIP=10.0.90.251" -o ./bin/linux_di/${APP} dilog.go struct.go dbapi.go network.go timecheck.go http.go templatefunc.go assets_vfsdata.go
GOOS=windows GOARCH=amd64 go build -ldflags "-X main.DBIP=10.0.90.251" -o ./bin/windows_di/${APP}.exe dilog.go struct.go dbapi.go network.go timecheck.go http.go templatefunc.go assets_vfsdata.go
GOOS=darwin GOARCH=amd64 go build -ldflags "-X main.DBIP=10.0.90.251" -o ./bin/darwin_di/${APP} dilog.go struct.go dbapi.go network.go timecheck.go http.go templatefunc.go assets_vfsdata.go
